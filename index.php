...
<html lang="ja">
 ...
 <body>
     ...
     <p class="login_name"><?php print(htmlspecialchars($member['name'],ENT_QUOTES));?>さん ログイン中</p>
...
<div class="msg">
    ...
    <a href="post_delete.php?id=<?php print(htmlspecialchars($post['id'])); ?>" class="del">削除</a>
<?php endif;?>
</div>
<?php endforeach; ?>
 </body>
